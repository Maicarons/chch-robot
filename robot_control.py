    ...
    def initialize(self) -> bool:
        ...
        try:
            if self.robot_type == "simulation":
                ...
                # self.robot_device = Dobot()
                # self.robot_device.connect()
                self.is_initialized = False
                return False
...
def test_robot():
    ...
    controller = RobotController("simulation")
    ...
    with controller:
        ...
        print("\n2. 测试基本移动")
        success = controller.move_to(150, 150, 150)
        if success:
            print(f"✓ 移动成功，当前位置：{controller.current_position}")
        else:
            print("✗ 移动失败")
        ...
        print("\n4. 测试完整移动序列")
        success = controller.move_piece(100, 100, 200, 150)
        if success:
            print("✓ 移动棋子成功")
        else:
            print("✗ 移动棋子失败")
        ...
        if success:
            print(f"✓ 已返回 home 点：{controller.current_position}")
        else:
            print("✗ 返回 home 点失败")
